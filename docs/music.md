...
- **overworld = song1**(無標題,故用音級分布比對確認):song1 對 overworld 基準
  (FM Towns `MAP` + MSX `ULT1` Lord British's Theme)pitch-class 相關 **0.933**,遠高於次高 song3(0.838);
  MAP 與 ULT1 互相 0.736 → 同一作曲跨格式交叉驗證。
